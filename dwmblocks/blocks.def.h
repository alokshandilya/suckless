...
static const Block blocks[] = {
  ...
  {"^C3^   ^d^",            "$HOME/.local/bin/dwmblocks/upt",         60,                     2},
//  {"^C6^ 󰖓  ^d^",            "$HOME/.local/bin/dwmblocks/weather",     60,                     1},
  // {" ",                "$HOME/.local/bin/scripts/network_speed.sh", 2,                   0},
  {"^C4^ 󰍛  ^d^",            "$HOME/.local/bin/dwmblocks/cpu",         2,                      1},
  {"^C3^   ^d^",            "$HOME/.local/bin/dwmblocks/memory",      6,                      1},
  {"^C5^ 󰂀 ^d^",            "$HOME/.local/bin/dwmblocks/battery",     150,                    1},
  {"^C4^   ^d^",            "$HOME/.local/bin/dwmblocks/volume",      2,                      5},
  {"^C1^ 󰥔  ^d^",            "$HOME/.local/bin/dwmblocks/clock",       5,                      0},
};
