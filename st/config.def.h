 ...
 */
static char *font = "JetBrains Mono:pixelsize=15:style:extrabold:antialias=true:autohint=true";
/* Spare fonts */
static char *font2[] = {
	"JetBrainsMono Nerd Font:pixelsize=15:style:extrabold:antialias=true:autohint=true",
